Step 1: Double Click on EmployeeMgmtVbTuto.sln
Step2 : In the shared folder, copy the database file called "EmployeeVbDb.mdf" and paste it in your documents
...
SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Username\Documents\EmployeeVbDb.mdf;Integrated Security=True;Connect Timeout=30");
